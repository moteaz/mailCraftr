    ...
    <nav className="fixed top-0 left-0 right-0 h-14 sm:h-16 bg-white border-b border-gray-200 z-50 backdrop-blur-sm bg-white/90">
      <div className="flex items-center justify-between h-full px-3 sm:px-4 lg:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
          ...
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center text-white font-semibold shadow-lg text-sm sm:text-base">
