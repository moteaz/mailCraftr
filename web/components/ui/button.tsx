...
export function Button({
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex items-center justify-center w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base',
        variants[variant],
        className
      )}
    >
